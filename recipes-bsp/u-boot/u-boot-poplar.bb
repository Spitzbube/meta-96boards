...
UBOOT_EXTLINUX_KERNEL_ARGS_poplar ??= "append mem=1G earlycon console=ttyAMA0"
UBOOT_EXTLINUX_KERNEL_ARGS_hi3798cv200-stb ??= "append mem=2G console=ttyAMA0 mmz=ddr,0,0,60M"
